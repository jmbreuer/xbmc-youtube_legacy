...
class TestYouTubeFolderStructure(BaseTestCase.BaseTestCase):
    def ttest_plugin_should_list_advanced_folder_structure_when_user_is_logged_in(self):
    ...
    def ttest_plugin_should_list_basic_folder_structure_when_user_is_not_logged_in(self):
        self.navigation.listMenu()
        # we probably need some better asserts here
    ...
    def ttest_plugin_should_list_subfolders_when_user_navigates_to_a_folder(self):
