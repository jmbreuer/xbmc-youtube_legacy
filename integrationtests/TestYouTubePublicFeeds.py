...
class TestYouTubePublicFeedsScraper(BaseTestCase.BaseTestCase):
    def ttest_plugin_should_list_categories_folder_list_correctly(self):
    ...
    def ttest_plugin_should_list_category_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_category_video_list_page_2_correctly(self):
    ...
    def ttest_plugin_should_list_live_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_most_viewed_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_most_linked_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_most_recent_videos_list_correctly(self):
    ...
    def ttest_plugin_should_list_most_responded_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_most_share_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_top_featured_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_trending_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_top_favorited_video_list_correctly(self):
    ...
    def ttest_plugin_should_list_top_rated_video_list_correctly(self):
