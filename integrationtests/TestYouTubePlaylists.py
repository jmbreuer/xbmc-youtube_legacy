...
class TestYouTubePlayer(BaseTestCase.BaseTestCase):
	...
	def ttest_plugin__should_queue_disco_search_and_start_playback_if_user_selects_play_all_outside_disco_search(self):
		sys.modules["__main__"].settings.load_strings("./resources/basic-login-settings.xml")
	...
	def ttest_plugin__should_queue_disco_search_and_start_playback_if_user_selects_play_all_in_disco_search(self):
		sys.modules["__main__"].settings.load_strings("./resources/basic-login-settings.xml")
	...
	def ttest_plugin__should_queue_youtube_top_100_and_start_playback_if_user_selects_play_all_outside_list(self):
		sys.modules["__main__"].settings.load_strings("./resources/basic-login-settings.xml")
	...
	def ttest_plugin__should_queue_user_watch_later_feed_if_user_selects_play_all_outside_list(self):
		sys.modules["__main__"].settings.load_strings("./resources/basic-login-settings.xml")
	...
	def ttest_plugin__should_queue_artist_video_list_if_user_selects_play_all_outside_list(self):
